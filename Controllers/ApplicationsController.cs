...
namespace FoodWasteManager.Controllers
{
    public class ApplicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ApplicationId,FoodPostId,CharityId,AStatus,OStatus")] Application application)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ApplicationId,FoodPostId,CharityId,AStatus,OStatus")] Application application)
        {
