...
namespace FoodWasteManager.Models
{
    public class FoodPost
    {
        ...
        [NotMapped, Required(ErrorMessage ="Please upload a recent photo of the food when editing a post.")]
        ...
        [Required, Range(0, 1000, ErrorMessage = "Value must be non-negative and less than 1000."), Display(Name = "Quantity")]
